 ...
 *         activated?: bool|Param, // Activate dispatching messages after import was prepared. Will start import as soon as messages are processed via symfony messenger. // Default: false
 *         worker_count_lifetime?: int|Param, // Lifetime of tmp store entry for current worker count entry. After lifetime, the value will be cleared. Default to 30 minutes. // Default: 1800
 *         worker_count_parallel?: int|Param, // Count of maximum parallel worker messages for parallel imports. // Default: 3
 *         worker_item_count?: int|Param, // Count of items imported per worker message. // Default: 200
 *     },
 * }
